...
**Language**: python
**Timestamp**: 2025-09-19T09:44:08.995783
...
- Replace 17 print statements with logger

## Pattern Matches by Category

### python_logging (1 patterns, 17 matches)
- ❌ **print-call**: 17 instances
  - Print statement
  - Example (line 5): `print("Bad 1")...`

### python_catalog (2 patterns, 252 matches)
- ✅ **prefer-generator-expressions**: 246 instances
